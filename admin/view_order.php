                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_menu.php">Thêm món</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="#">ONLINE FOOD HQ</a> - HỌC VIỆN QUẢN LÝ GIÁO DỤC.</marquee>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">Thông tin đơn hàng</h4>
                                                </div>
											...
											$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id where o_id='".$_GET['user_upd']."'";
												...
												?>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                                                            <button type="button" class="btn btn-primary">Cập nhập trạng thái đơn hàng</button></a>
                                                                    </center>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                                                            <button type="button" class="btn btn-primary">Thông tin khách hàng</button></a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center>VND<?php echo $rows['price']; ?></center>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
																			...
																			?>
                                                                <td>
                                                                    <center><button type="button" class="btn btn-primary"><span class="fa fa-check-circle" aria-hidden="true"></span> Đã giao</button></center>
                                                                </td>
                                                                <?php 
																			} 
																			?>
                    ...
                    <footer class="footer"> © 2025 - Đồ ăn nhanh HQ </footer>
